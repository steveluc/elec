...
export function authenticate(win: BrowserWindow) {
  ...
  let scope =
    "user-read-private user-read-email streaming user-top-read user-read-currently-playing user-read-recently-played user-read-playback-state user-modify-playback-state";
